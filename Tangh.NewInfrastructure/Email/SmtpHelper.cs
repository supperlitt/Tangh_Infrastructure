...
namespace Tangh.NewInfrastructure.Email
{
    public class SmtpHelper
    {
        ...
        /// SMTP构造函数
        /// </summary>
        /// <param name="sendMailAccount">发件箱; eg:dzcmcc@163.com</param>
        /// <param name="sendMailPwd">邮箱密码</param>
        /// <param name="sendSMTP">smtp服务器地址；eg:smpt.163.com</param>
        /// <param name="notifyEmail">测试邮箱地址;eg:test@test.com</param>
